...
Por supuesto, aquí tienes la lista de comandos de Linux en formato Markdown:
...
- `|`: Canaliza la salida de un comando a la entrada de otro.
...
- `uptime`: Muestra el tiempo transcurrido desde que se inició el sistema.
